...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Create Staff</li>
        </ol>
    </section>
    <!-- Main content -->
                            ...
                            <select class="form-control" name="blood_name"> 
                                ...
                                <?php if(count($blood_name) > 0){ 
                                    foreach($blood_name as $bdq){
                                        ?>
                                        <option value="<?php echo $bdq->bloodbank_id;?>" <?php echo set_select("blood_name",$bdq->bloodbank_id);?>><?php echo $bdq->bloodbank_name;?></option>
                                <?php }
                                }?>
                            </select>                            
