...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Out Blood Availability
            <small>Viewing Out Blood Availability</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo base_url("admin/dashboard");?>"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="javascript:void(0);">Reports</a></li>
            <li class="active">Out Blood Availability</li>
        </ol>
    </section>
    <!-- Main content -->
      ...
      <!-- SELECT2 EXAMPLE -->
        <div class="box box-default">
            <div class="box-header with-border">
                <h3 class="box-title">Out Blood Availability Reports</h3>
            ...
            <div class="box-body">  
               ...
               <?php if($this->session->userdata("login_type") != '3utype') {?>
                <div class="col-sm-4">
                    <div class="form-group"> 
                        ...
                        <select class="form-control district report_district" name="district"  onchange="search_summary('<?php echo base_url(); ?>admin/viewOutBloodAvailability/')">
                ...
                <div class="col-sm-4">
                    <div class="form-group"> 
                        <label>City</label>
                        <select class="form-control city report_city" name="city" onchange="search_summary('<?php echo base_url(); ?>admin/viewOutBloodAvailability/')">
			   ...
			   <?php } ?>
                <div class="col-sm-4">
                    ...
                    <select class="form-control searbloodbank_id" name="bloodbank_id" onchange="search_summary('<?php echo base_url(); ?>admin/viewOutBloodAvailability/')">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        <label> <input type="checkbox" name="zero_units" class="zero_units" value="0" onchange="search_summary('<?php echo base_url(); ?>admin/viewOutBloodAvailability/')"/> Zero Units </label>
                    </div>
                </div> 
                <div class="col-sm-4">
                ...
                <div class="col-md-4">
                    <div class="form-group"> 
                        <input type="text" class="form-control pull-right daterange" placeholder="Date ..." name="datem" value_url="<?php echo base_url(); ?>admin/viewOutBloodAvailability/" /> 
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <input type="hidden" class="varurl" value="<?php echo base_url(); ?>admin/viewOutBloodAvailability/"/>
                    </div>
                </div>
                <div class="col-sm-12">
<!--                    <div class="pull-right form-group"><a href="<?php echo base_url("admin/export_excel/0");?>" class="btn_excelhref btn btn-success btn-sm">Export to Excel</a></div>-->
